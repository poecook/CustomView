...
public class Rotate3DViewGroup extends ViewGroup {
    //可对外进行设置的参数
    ...
    public Rotate3DViewGroup(Context context) {
        this(context, null);
    }

    public Rotate3DViewGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Rotate3DViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @return
     */
    public Rotate3DViewGroup setStartScreen(int startScreen) {
     ...
     * @return
     */
    public Rotate3DViewGroup setResistance(float resistance) {
     ...
     * @return
     */
    public Rotate3DViewGroup setInterpolator(Interpolator mInterpolator) {
     ...
     * @return
     */
    public Rotate3DViewGroup setAngle(float mAngle) {
     ...
     * @return
     */
    public Rotate3DViewGroup setCan3D(boolean can3D) {
        isCan3D = can3D;
        return this;
    }
     ...
     * @return
     */
    public Rotate3DViewGroup setItem(int itemId) {
     ...
     * @return
     */
    public Rotate3DViewGroup toPre() {
        if (!mScroller.isFinished()) {
            mScroller.abortAnimation();
        }
     ...
     * @return
     */
    public Rotate3DViewGroup toNext() {
        if (!mScroller.isFinished()) {
            mScroller.abortAnimation();
